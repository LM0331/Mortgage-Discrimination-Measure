...
saveRDS(hmda_geo2,here("hmda_geo_final.rds"))

hmda_geo2 <- readRDS(here("hmda_geo_final.rds"))
...
bayesian_1 <- do.call(rbind, alldata_list)
summary(bayesian_1$IRR)
write_rds(alldata_list, "~/Desktop/bayesian_US.rds")
