...
hmda <- read.csv(here(file_path, "data", file = "hmda_2010_nationwide_all-records_codes.csv"),
...
hmda11 <- read.csv(here(file_path, "data", file="hmda_2011_nationwide_all-records_codes.csv"), 
                   colClasses=c("applicant_race_2"="NULL", "applicant_race_3"="NULL", "applicant_race_4"="NULL", "applicant_race_5"="NULL",
                                "co_applicant_race_1"="NULL", "co_applicant_race_2"="NULL", "co_applicant_race_3"="NULL", "co_applicant_race_4"="NULL", 
                                "co_applicant_race_5"="NULL", "co_applicant_ethnicity"="NULL", "applicant_income_000s"="numeric", "loan_amount_000s"="numeric", 
                                .default="character"))
...
hmda12 <- read.csv(here(file_path, "data", file="hmda_2012_nationwide_all-records_codes.csv"), 
                   colClasses=c("applicant_race_2"="NULL", "applicant_race_3"="NULL", "applicant_race_4"="NULL", "applicant_race_5"="NULL",
                                "co_applicant_race_1"="NULL", "co_applicant_race_2"="NULL", "co_applicant_race_3"="NULL", "co_applicant_race_4"="NULL", 
                                "co_applicant_race_5"="NULL", "co_applicant_ethnicity"="NULL", "applicant_income_000s"="numeric", "loan_amount_000s"="numeric", 
                                .default="character"))
...
hmda13 <- read.csv(here(file_path, "data", file="hmda_2013_nationwide_all-records_codes.csv"),
                   colClasses=c("applicant_race_2"="NULL", "applicant_race_3"="NULL", "applicant_race_4"="NULL", "applicant_race_5"="NULL",
...
hmda14 <- read.csv(here(file_path, "data", file="hmda_2014_nationwide_all-records_codes.csv"),
                   colClasses=c("applicant_race_2"="NULL", "applicant_race_3"="NULL", "applicant_race_4"="NULL", "applicant_race_5"="NULL",
                                "co_applicant_race_1"="NULL", "co_applicant_race_2"="NULL", "co_applicant_race_3"="NULL", "co_applicant_race_4"="NULL", 
...
crosswalk<- read.csv(here(file_path, "data", "us2010trf.txt"), header=FALSE, colClasses ="character")
cw2 <-crosswalk %>% 
...
cbsa19 <- read_csv(here(file_path, "data", "cbsa-est2019-alldata.csv")) %>% 
  janitor:: clean_names() %>% 
...
msaUS <- read_csv(here(file_path, "data", "cbsa-est2019-alldata.csv")) %>% 
  janitor:: clean_names() %>% 
  dplyr::select(cbsa, stcou, name, lsad) %>% 
...
#16,816,010 mortgage apps
#10.33% denials
#60,488 unique tracts 
...
write_rds(alldata, here::here("allMSAsC.rds"))
